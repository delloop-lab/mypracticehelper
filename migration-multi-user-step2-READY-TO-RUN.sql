-- ============================================================================
-- MULTI-USER MIGRATION - STEP 2: Create First User (READY TO RUN)
-- ============================================================================
-- This creates the first user and assigns all existing data to them
-- Password hash is already included - just run this SQL!
-- ============================================================================

-- Create user and assign all data in one transaction
DO $$
DECLARE
  v_user_id TEXT;
